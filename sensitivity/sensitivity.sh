...
python3 ../perfusion/BC_creator.py --res_fldr '../sensitivity/' --config_file '../sensitivity/config_healthy00.yml'
python3 ../perfusion/BC_creator.py --res_fldr '../sensitivity/' --config_file '../sensitivity/config_RMCA_occl00.yml' --occluded
