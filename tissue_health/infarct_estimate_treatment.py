...
The script can be run with and without arguments. When no arguments are given,
the default configuration file at `./config_tissue_damage.yaml` is considered
and no `tissue_health_outcome.yml` is written (the latter is an insist-pipeline
specific outcome.)
